...
class UnsplashService {
    ...
    /// Search for photos on Unsplash with a given query
    private func searchPhoto(query: String) async throws -> UnsplashPhoto? {
    ...
    func searchCityPhoto(cityName: String, country: String? = nil) async throws -> UnsplashPhoto? {
        ...
        query += " cityscape"
        return try await searchPhoto(query: query)
    }

    /// Search for country photos on Unsplash
    func searchCountryPhoto(countryName: String) async throws -> UnsplashPhoto? {
